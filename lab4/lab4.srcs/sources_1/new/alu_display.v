...
// Engineer: 
// 
// Create Date: 2026/05/09 12:15:27
// Design Name: 
...
module alu_display(
    ...
    //拨码开关，用于选择屏幕输入目标
    input [1:0] input_sel, //10:输入为源操作数1(alu_src1)
                           //11:输入为源操作数2(alu_src2)
    //拨码开关，用于直接输入ALU 4位控制编码
    input [3:0] alu_control_sw,
