...
#拨码开关连接
# sw0~sw3: ALU控制编码（4bit）
set_property PACKAGE_PIN AC21 [get_ports alu_control_sw[0]]
set_property PACKAGE_PIN AD24 [get_ports alu_control_sw[1]]
set_property PACKAGE_PIN AC22 [get_ports alu_control_sw[2]]
set_property PACKAGE_PIN AC23 [get_ports alu_control_sw[3]]

# sw6~sw7: 选择触摸屏输入写入SRC_1/SRC_2
set_property PACKAGE_PIN AA7 [get_ports input_sel[0]]
set_property PACKAGE_PIN Y6  [get_ports input_sel[1]]

set_property IOSTANDARD LVCMOS33 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports resetn]
set_property IOSTANDARD LVCMOS33 [get_ports alu_control_sw[0]]
set_property IOSTANDARD LVCMOS33 [get_ports alu_control_sw[1]]
set_property IOSTANDARD LVCMOS33 [get_ports alu_control_sw[2]]
set_property IOSTANDARD LVCMOS33 [get_ports alu_control_sw[3]]
