...
set_property PACKAGE_PIN H7   [get_ports led_done]
...
set_property PACKAGE_PIN Y5   [get_ports key_step0]
set_property PACKAGE_PIN V6   [get_ports key_step1]
...
set_property IOSTANDARD LVCMOS33 [get_ports key_step0]
set_property IOSTANDARD LVCMOS33 [get_ports key_step1]
