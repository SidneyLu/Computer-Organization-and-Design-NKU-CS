...
HD_PWD='D:/1012/project1/project1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_compare_booth_simd_pipe_dsp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_compare_booth_simd_pipe_dsp_top.tcl
