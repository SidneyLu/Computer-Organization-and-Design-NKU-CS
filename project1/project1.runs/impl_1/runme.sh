...
HD_PWD='D:/1012/project1/project1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_compare_booth_simd_pipe_dsp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnn_compare_booth_simd_pipe_dsp_top.tcl -notrace
