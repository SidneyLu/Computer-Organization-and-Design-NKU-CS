...
#
# Script generated by Vivado on Sun Jun 07 17:12:10 +0800 2026
...
# script info
echo -e "data_ram.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_ram xil_defaultlib.data_ram xil_defaultlib.glbl -log elaborate.log
}
